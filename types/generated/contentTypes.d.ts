...
export interface ApiAboutAbout extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Write about yourself and the content you create, per site';
    displayName: 'About';
    pluralName: 'abouts';
    singularName: 'about';
  };
...
export interface ApiGlobalGlobal extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Define global settings per site';
    displayName: 'Global';
    pluralName: 'globals';
    singularName: 'global';
  };
...
export interface ApiSiteSite extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A site served by this CMS (e.g. jetvesper.com)';
    displayName: 'Site';
    pluralName: 'sites';
    singularName: 'site';
  };
  ...
  attributes: {
    abouts: Schema.Attribute.Relation<'oneToMany', 'api::about.about'>;
    articles: Schema.Attribute.Relation<'oneToMany', 'api::article.article'>;
